...
export const WHATSAPP_MESSAGE =
  'Olá Moacir! Vi seu site e quero conversar sobre um projeto de e-commerce.';
export const WHATSAPP_HREF = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(WHATSAPP_MESSAGE)}`;

export const LINKEDIN_HANDLE = 'moacirjun';
export const LINKEDIN_HREF = `https://www.linkedin.com/in/${LINKEDIN_HANDLE}`;
